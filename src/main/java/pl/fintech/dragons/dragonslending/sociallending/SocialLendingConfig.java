...
import pl.fintech.dragons.dragonslending.sociallending.payment.transaction.infrastructure.MoneyTransactionConfig;
import pl.fintech.dragons.dragonslending.sociallending.security.SecurityConfig;

@Configuration
@Import({SecurityConfig.class, AccountConfig.class, UserConfig.class, EventPublisherConfig.class, MoneyTransactionConfig.class})
