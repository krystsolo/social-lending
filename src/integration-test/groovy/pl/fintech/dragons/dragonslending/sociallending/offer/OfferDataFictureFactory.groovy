...
class OfferDataFictureFactory {
    ...
    static final LoanCalculationDto CALCULATION_DTO = new LoanCalculationDto(BigDecimal.valueOf(RandomUtils.nextInt(0, 1000000)), BigDecimal.valueOf(RandomUtils.nextInt(0, 1000000)))

    static final OfferQueryDto OFFER_QUERY = OFFER.toOfferDto(UserData.USER.username, CALCULATION_DTO)
